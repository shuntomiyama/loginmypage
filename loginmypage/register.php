     ...
     <div class="form_contents">
      ...
      <div class="password">
       <div class="hissu">必須</div><label>パスワード確認</label><br>
        <input type="text" class="formbox" size="40" name="confirm_password" id="confirm_password" oninput="ConfirmPassword(this)" required>
      </div>
      <div class="picture">
      ...
      <div class="toroku">
       <input type="submit" class="submit_bottun" size="35" value="登録する">
      </div>
     </div>   
    </form> 
  </main>
